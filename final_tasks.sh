...
# Remove xml-data/build-dir
echo "Removing data in build-dir"
rm -rf /mnt/storage/bamboo-agent-home/xml-data/build-dir/O*
rm -rf /mnt/storage/bamboo-agent-home/xml-data/build-dir/VFS*
rm -rf /mnt/storage/bamboo-agent-home/xml-data/build-dir/TEST*
